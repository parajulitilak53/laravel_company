        ...
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto">
                <a href="{{ url('/') }}" class="logo me-auto me-lg-0"><img
                        src="{{ asset('frontend-assets/img/logo-kritirm-final.png') }}" alt=""
                        class="img-fluid"></a>
            </h1>
            @section('content')
                <div class="header-social-links d-flex">
                    @foreach ($settings as $set)
                       @if ($set->site_key == 'twitter')
                          <a href="{{ $set->site_value }}" target="_blank" rel="noopener noreferrer" class="twitter"><i
                            class="bu bi-twitter"></i></a>
                   @endif
                @endforeach
                    @foreach ($settings as $set)
                        @if ($set->site_key == 'facebook')
                           <a href="{{ $set->site_value }}" target="_blank" rel="noopener noreferrer" class="facebook"><i
                                class="bu bi-facebook"></i></a>
                       @endif
                    @endforeach
                    @foreach ($settings as $set)
                        @if ($set->site_key == 'instagram')
                           <a href="{{ $set->site_value }}" target="_blank" rel="noopener noreferrer" class="instagram"><i
                                class="bu bi-instagram"></i></a>
                       @endif
                    @endforeach
                    @foreach ($settings as $set)
                        @if ($set->site_key == 'linkedin')
                           <a href="{{ $set->site_value }}" target="_blank" rel="noopener noreferrer" class="linkedin"><i
                    ...
                    <div class="row portfolio-container" data-aos="fade-up">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                            ...
                            <div class="portfolio-info">
                                ...
                                <a href="{{ url('/portfolio-details') }}" class="details-link" title="More Details"><i
