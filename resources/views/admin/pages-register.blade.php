              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourPhoneNo" class="form-label">Your Phone No.</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"><i class="bi bi-telephone"></i></span>
                        <input type="tel" name="phone" class="form-control" id="yourPhoneNo" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="save" type="submit">Create Account</button>
                    </div>
                    <div class="col-12">
