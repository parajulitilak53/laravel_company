    ...
    <section class="section">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update Setting #{{$setting->site_key}}
              ...
              <form class="row g-3" action="{{route('settings.update',$setting->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="site_key" class="form-control" value="{{old('site_key',$setting->site_key)}}" id="inputNanme4">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="site_value" class="form-control" value="{{old('site_value',$setting->site_value)}}" id="inputNanme4">
